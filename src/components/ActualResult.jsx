    ...
    return (
        <div className="bg-cover relative bg-no-repeat overflow-hidden bg-center bg-sliderBg min-h-screen flex flex-col justify-center items-center">
            <div className="text-center xl:pt-[109px] lg:pt-20 md:pt-16 pt-[60px]">
                ...
                <p className="text-white font-spaceMono font-normal text-[15px] leading-[20px]">
            ...
            <div className="max-w-[1440px] w-full pt-[81px] relative">
                    ...
                    {RESULT_SLIDER_LIST.map((slide, index) => (
                        <SwiperSlide key={index}>
                            <div className="text-center">
                                ...
                                <p className="text-white xl:pt-[74px] lg:pt-16 md:pt-12 pt-[30px] !leading-[132%] font-maisonLight font-light max-w-[603px] max-sm:px-4 mx-auto text-3xl">
                                    {`"${slide.description}"`}
                                </p>
                                ...
                                <p className="text-center pt-[9px] pb-[133px] mx-auto flex items-center justify-center">
                                    <UsIcon />
                                </p>
                ...
                <div className="swiper-button-prev absolute lg:translate-x-1 -translate-x-1 xl:!top-[29%] md:top-[50%] max-md:!hidden transform translate-y-[-50%]">
                ...
                <div className="swiper-button-next absolute lg:-translate-x-1 top-[50%] transform xl:!top-[29%] translate-y-[-50%] max-md:!hidden">
