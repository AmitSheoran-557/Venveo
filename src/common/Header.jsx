  ...
  return (
    <div className="mx-auto max-w-[1440px]">
      <div className="flex justify-between max-lg:pt-5 max-md:pt-4 max-lg:items-center text-white relative">
        <a href="/">
          <img
            className="xl:max-w-[59px] lg:max-w-12 max-w-[42px] lg:pt-[29px] xl:ml-[57px] lg:ml-12 md:ml-8 ml-4"
            src={logo}
            alt="venveo-logo"
          />
        </a>
        ...
        >
          <span
            className={`w-6 transition-all duration-300 h-0.5 bg-white mb-1 rounded-md relative after:w-full after:h-full after:bg-white after:absolute after:top-0 after:left-0 after:rounded-md ${
              open ? 'rotate-45 after:rotate-90 !bg-black after:!bg-black' : ''
            }`}
          ></span>
          <span
            className={`w-6 transition-all duration-300 h-0.5 bg-white rounded-md ${
              open ? '-translate-x-10 !bg-black' : ''
            }`}
          ></span>
        </button>
        ...
        <div className="flex max-h-20">
          <div
            className={`flex gap-[42px] bg-white !text-black max-lg:text-white ps-[41px] pe-[29px] py-[30px] lg:max-h-max max-lg:fixed max-lg:top-0 max-lg:h-full max-lg:w-full max-lg:flex-col max-lg:bg-white max-lg:duration-300 max-lg:justify-center max-lg:items-center z-40 ${
          ...
          >
            ...
            <button
              onClick={handleOpen}
              className="lg:hidden max-lg:block hover:scale-[1.05] duration-300 transition-all ease-linear"
            >
          ...
          <button className="bg-yellowGreen max-lg:hidden px-[31px] hover:bg-[#0D99A0] duration-300 ease-in-out flex items-center justify-center gap-1 text-black text-[15px] group text-center font-semibold">
            Let’s Talk{' '}
            <span className="group-hover:translate-x-3 transition-all ease-linear">
              <ArrowIcon />
            </span>{' '}
          </button>
        </div>
